      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground">
            Trang demo để kiểm tra các component shadcn/ui với theme manga và dark mode
          </p>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Các loại button khác nhau với theme manga</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Input, textarea, select và các form control khác</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Checkbox, switch và các component tương tác khác</CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="notifications">Nhận thông báo manga mới</Label>
            </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Avatar component với các kích cỡ khác nhau</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Manga Creator</p>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Kiểm tra color palette manga theme - {darkMode ? "Dark Mode" : "Light Mode"}
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="mt-6 p-4 border rounded-lg">
              ...
              <div className="grid grid-cols-2 gap-2 text-sm">
                <span>Mode: <Badge variant="outline">{darkMode ? "Dark" : "Light"}</Badge></span>
                <span>Color Space: <Badge variant="outline">OKLCH</Badge></span>
                <span>Base Hue: <Badge variant="outline">240° (Blue)</Badge></span>
                <span>Framework: <Badge variant="outline">Radix UI</Badge></span>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="text-center p-6 border border-green-500/20 bg-green-500/10 rounded-lg">
          ...
          <p className="text-muted-foreground">
            Tất cả component đã hoạt động tốt! Shadcn/UI (Radix UI) đã được setup đúng cách với theme manga.
          </p>
        </div>
      </div>
    </div>
